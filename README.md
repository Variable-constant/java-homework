...
Для тестирования программы требуется запустить соответсвующий каждому домашнему заданию исполняющий файл из [тестов](https://github.com/Variable-constant/java-homework/tree/master/java). Для каждого тестового файла указан его usage. Все тесты следует запускать с параметром enable asserts.
